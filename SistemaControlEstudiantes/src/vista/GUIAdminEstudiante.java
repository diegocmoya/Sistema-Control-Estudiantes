...
public class GUIAdminEstudiante extends GUIMantenimiento {
    ...
    /**
     * Creates new form GUIAdminEstudiante
     */
    RegistroEstudiantes registro;
    
    public GUIAdminEstudiante() {
        super();    
        //initComponents();
    }
    ...
    public void init(){
        ...
        ManejadorEstudiante manejador=new ManejadorEstudiante(registro,this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIAdminEstudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new GUIAdminEstudiante().setVisible(true);
            }
        });
    }
